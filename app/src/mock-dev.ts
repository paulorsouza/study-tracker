...
const respostas: Record<string, (a: any) => unknown> = {
  ...
  listar_podcasts: () => [
    {
      id: "p1",
      titulo: "Stock Pickers",
      feed_url: "https://exemplo/feed.xml",
      site: null,
      ...
      ativo: true,
      atualizado_em: Date.now() - 3600_000,
      novos: 2,
    },
  ],
  listar_episodios: () => [
    {
      ...
      titulo: "O que muda com a nova certificação",
      url: null,
      publicado_em: Date.now() - 86400_000,
      duracao_s: 3720,
      estado: "novo",
      dia_planejado: null,
      cor: "#2a78d6",
  ...
  podcasts_importar_opml: () => ({ novos: 3, ja_tinha: 1 }),
  podcasts_atualizar: () => ({ feeds: 4, episodios_novos: 7, erros: [] }),
  podcast_categoria: () => null,
  excluir_podcast: () => null,
  episodio_estado: () => null,
  planejar_episodio: () => "t1",
  listar_rotinas: () => [
    {
      id: "r1",
      titulo: "CPA — estudo",
